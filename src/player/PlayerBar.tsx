...
export function PlayerBar({ logoUrl }: Props) {
  ...
  return (
    <div role="region" aria-label="Player radio" className="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-[#0a0a0f] sm:bg-[#0a0a0f]/95 text-white sm:backdrop-blur-xl shadow-md sm:shadow-[0_-8px_32px_rgba(0,0,0,0.8)] transform-gpu will-change-transform">
          ...
          <button
            ...
            className={`group relative flex size-12 sm:size-13 items-center justify-center rounded-2xl border transition-all duration-300 hover:scale-110 active:scale-95 ${
              isOn
                ...
                : 'border-white/25 bg-gradient-to-br from-brand/35 via-white/[0.08] to-brand/15 text-white sm:backdrop-blur-md shadow-[0_0_12px_rgba(200,36,227,0.35)] sm:shadow-[0_0_20px_rgba(200,36,227,0.4)] hover:border-brand hover:from-[#e0246f] hover:to-brand hover:shadow-[0_0_30px_rgba(200,36,227,0.7)]'
            }`}
          >
            {status === 'loading' ? (
